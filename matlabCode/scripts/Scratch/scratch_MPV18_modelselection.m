...
cd('/mnt/data/Mitra/cache/repos/ldsForNeuralPopulation/cluster/MPV18_2/trial_based_MS_split_0/50msBins')
%load('nStates9-Fold1_V1_PLDSfitRes_21_09_09_15_42_40.mat')
%resTr = ModelSelection;

doPlot = 0;
FittedFold = 1; doPlot=0;


% by default reads tghe latest version
test_ll = nan(1,50);
for st = 14:numel(test_ll)
    st
    ...
    if numel(File)
        ...
        test_ll(st) = mean(mean(test_trial_ll));
    end
end
